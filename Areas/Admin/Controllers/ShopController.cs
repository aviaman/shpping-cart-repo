    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult EditProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            using (Db db = new Db())
            {
                ProductDTO dto = db.Products.Find(id);
                dto.Name = model.Name;
                dto.Slug = model.Name.Replace(" ", "_").ToLower();
        ...
        [HttpPost]
        public ActionResult SaveGalleryImages(HttpPostedFileBase file, int id)
        {
        ...
        {
            var fullPath1 = Server.MapPath("~/Images/Uploads/Products/" + id.ToString() + "/Gallery/" + imageName);
            var fullPath2 = Server.MapPath("~/Images/Uploads/Products/" + id.ToString() + "/Gallery/Thumbs/" + imageName);
